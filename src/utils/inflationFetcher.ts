let cachedData: Record<string, { pureIndex: number; adjustedIndex: number }> | null = null;
let fetchPromise: Promise<Record<string, { pureIndex: number; adjustedIndex: number }>> | null = null;
